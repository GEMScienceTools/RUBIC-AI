...
def get_street_view_image_with_orientation(
    location,
    found_close=False,
    max_radius=50,
    step=20,
...
if __name__ == "__main__":
    coord = (32.53499907, -117.0021232)  # Lisbon example

    maps_url, img, year, pano_coords, found_close, radius, side, angle = get_street_view_image_with_orientation(
        location=coord,
        found_close=False,
        max_radius=50,
        step=20,
