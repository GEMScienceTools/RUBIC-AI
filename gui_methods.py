...
#####################################################################  
    ...
    def neighbor_extrapolation(self):
        ...
        if self.ui.insp_method == 3:
            try:
                self.n_neighbor = int(self.ui.n_neighbor)
                neighbor_method = self.ui.neighbor_method
            except:
                self.n_neighbor = 10
                neighbor_method = 1
            
            try:
                self.neighbor_distance = float(self.ui.distance)
            except:
            ...
            building_no_info = pd.read_csv(self.building_extra_path)
            building_reference = pd.read_csv(self.example_building_path)
            ...
            for idx, input_row in building_no_info.iterrows():
                ...
                nearest_neighbors = find_nearest_neighbors_geodesic(input_row, building_reference, 
                                                                    self.n_neighbor, neighbor_method,
