"""Provide the polygon-based building sampling dialog for RUBIC-AI."""
...
class PolygonSetting(QtWidgets.QDialog):
    """Configure polygon inputs, footprints, and building samples."""
    ...
    def __init__(self, parent=None, method=None):
        ...
        self.backg_1.setGeometry(
            QtCore.QRect(
                int(10 * sf_x), int(10 * sf_y), int(601 * sf_x), int(651 * sf_y)
            )
        )
        ...
        self.polygon_label.setGeometry(
            QtCore.QRect(
                int(210 * sf_x), int(20 * sf_y), int(221 * sf_x), int(21 * sf_y)
            )
        )
        ...
        self.output_label_polygon.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(50 * sf_y), int(121 * sf_x), int(31 * sf_y)
            )
        )
        ...
        self.output_polygon.setGeometry(
            QtCore.QRect(
                int(160 * sf_x), int(50 * sf_y), int(231 * sf_x), int(31 * sf_y)
            )
        )
        ...
        self.path_out_folder_bt.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(95 * sf_y), int(231 * sf_x), int(31 * sf_y)
            )
        )
        ...
        self.output_folder_value.setGeometry(
            QtCore.QRect(
                int(270 * sf_x), int(100 * sf_y), int(331 * sf_x), int(21 * sf_y)
            )
        )
        ...
        self.polygon_source_label.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(140 * sf_y), int(151 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.polygon_source_value.setGeometry(
            QtCore.QRect(
                int(170 * sf_x), int(140 * sf_y), int(201 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.input_button_polygon.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(190 * sf_y), int(201 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.polygon_path_value.setGeometry(
            QtCore.QRect(
                int(240 * sf_x), int(190 * sf_y), int(291 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.footprint_label.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(240 * sf_y), int(151 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.footprint_mode.setGeometry(
            QtCore.QRect(
                int(180 * sf_x), int(240 * sf_y), int(241 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.load_data_button.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(290 * sf_y), int(271 * sf_x), int(31 * sf_y)
            )
        )
        ...
        self.footprint_progress_label.setGeometry(
            QtCore.QRect(
                int(450 * sf_x), int(290 * sf_y), int(151 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.footprint_progress.setGeometry(
            QtCore.QRect(
                int(310 * sf_x), int(295 * sf_y), int(121 * sf_x), int(21 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.n_building.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(330 * sf_y), int(121 * sf_x), int(31 * sf_y)
            )
        )
        ...
        self.building_value_polygon.setGeometry(
            QtCore.QRect(
                int(160 * sf_x), int(330 * sf_y), int(211 * sf_x), int(31 * sf_y)
            )
        )
        ...
        self.sample_size.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(370 * sf_y), int(121 * sf_x), int(31 * sf_y)
            )
        )
        ...
        self.sample_size_polygon.setGeometry(
            QtCore.QRect(
                int(160 * sf_x), int(370 * sf_y), int(111 * sf_x), int(31 * sf_y)
            )
        )
        ...
        self.collection_mode.setGeometry(
            QtCore.QRect(
                int(250 * sf_x), int(410 * sf_y), int(191 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.feature_collection_label.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(410 * sf_y), int(221 * sf_x), int(31 * sf_y)
            )
        )
        font = QtGui.QFont()
        font.setPointSize(int(10 * sf_font))
        ...
        self.tableWidget.setGeometry(
            QtCore.QRect(
                int(20 * sf_x), int(450 * sf_y), int(581 * sf_x), int(192 * sf_y)
            )
        )
        ...
        self.save_button.setGeometry(
            QtCore.QRect(
                int(220 * sf_x), int(670 * sf_y), int(191 * sf_x), int(31 * sf_y)
            )
        )
    ...
    def _on_select_output_folder(self):
        ...
        self.method.output_folder_value, self.display_folder = select_output_folder(
            self
        )
        self.output_folder_value.setText(self.display_folder)

    def upload_input(self):
        """Call the appropriate input loader for the selected polygon source."""
    ...
    def select_polygon(self):
        """Select, validate, and save an existing polygon boundary."""
        output_file_existing = os.path.join(
            self.method.output_folder_value,
            f"{self.output_polygon.text()}_boundary.gpkg",
        )
        # Open file dialog restricted to .shp and .gpkg
        file_path, _ = QFileDialog.getOpenFileName(
            None, "Select Polygon File", "", "Vector files (*.shp *.gpkg)"
        )
        if file_path:
            ...
            gdf = self.load_polygon_layer(
                path=file_path, expected_crs="EPSG:4326", fix_invalid=True
            )
            self.save_polygon_layer(
                gdf, output_path=output_file_existing, layer="boundary", overwrite=True
            )
    ...
    def _on_save_coordinates(self):
        """Validate and save the polygon coordinates."""
    ...
    def building_sample(self):
        """Create the selected building sample and its centroid layer."""
        try:
            ...
            if self.building_value_polygon.text() == "0000":
                QMessageBox.warning(
                    ...
                    "Please click *Get footprints available* before saving "
                    "and continuing.",
                )
            else:
                self.accept()
    ...
    def load_polygon_layer(  # noqa: C901
        self,
        path: str,
        layer: str | None = None,
        ...
        """Load and validate a polygon layer.

        Display a warning and return ``None`` when the source cannot be used.
        ...
        if not path or not os.path.exists(path):
            QMessageBox.warning(
                self, "File not found", f"The path does not exist:\n{path}"
            )
            return None
        ...
        try:
            ...
            QMessageBox.warning(
                ...
                "Error reading file",
                (
                    "GeoPandas/Fiona could not read the file.\n\n"
                    f"File: {path}\nError:\n{e}"
                ),
            )
            return None
        ...
        if gdf is None or len(gdf) == 0:
            QMessageBox.warning(
                self, "Empty layer", "The file was read but contains no features."
            )
            return None
        ...
        if "geometry" not in gdf.columns:
            QMessageBox.warning(
                self,
                "No geometry column",
                "The layer does not contain a geometry column.",
            )
            return None
        ...
        if fix_invalid:
            try:
                ...
                if invalid_count > 0:
                    ...
                    gdf_polys.loc[invalid_mask, "geometry"] = gdf_polys.loc[
                    ...
                    if still_invalid > 0:
                        QMessageBox.warning(
                            ...
                            "Invalid geometries",
                            (
                                f"{still_invalid} geometries remain invalid "
                                "after attempting to fix them."
                            ),
                        )
            except Exception as e:
                QMessageBox.warning(
            ...
            try:
                ...
                if before == after and str(before).lower() != str(expected_crs).lower():
                    ...
                    QMessageBox.warning(
                        ...
                        (
                            f"Requested CRS {expected_crs}, but the layer "
                            f"remains in {before}."
                        ),
                    )
            except Exception as e:
            ...
            for geom in gdf_polys.geometry:
                if not isinstance(geom, (Polygon, MultiPolygon)):
                    QMessageBox.warning(
                        ...
                        "Mixed geometries",
                        (
                            "Some features are not polygonal after filtering. "
                            "Please verify the source data."
                        ),
                    )
                    break
        except Exception:
            # Continue with the best effort if Shapely/GeoPandas type checks fail.
            pass

        return gdf_polys

    def save_polygon_layer(  # noqa: C901
        self,
        ...
        if not output_path:
            QMessageBox.warning(
                self, "Invalid path", "Please provide a valid output path."
            )
            return False
        ...
        if os.path.exists(output_path):
            if overwrite:
                try:
                    ...
                    # A Shapefile has multiple sidecar files, so overwrite in place.
                    # If the driver cannot overwrite, remove the files below.
                except Exception as e:
                    QMessageBox.warning(
                        self,
                        "Overwrite failed",
                ...
                if ext == ".shp":
                    QMessageBox.warning(
                        ...
                        "File exists",
                        (
                            "The Shapefile already exists and overwrite=False. "
                    ...
                    candidate = base
                    n = 1
                    # Add numeric suffixes without requiring extra dependencies.
                    while True:
                        try:
                            gdf.to_file(
                                output_path, driver="GPKG", layer=candidate, index=False
                            )
                            return True
                        except Exception as e:
                            # Try another name when the layer schema conflicts.
                            n += 1
                            ...
                            if n > 50:  # avoid infinite loops
                                QMessageBox.warning(
                                    ...
                                    "Save failed",
                                    (
                                        "Could not find a free layer name in the "
                                        f"GPKG.\nLast error:\n{e}"
                                    ),
                                )
                                return False
        ...
        try:
            if ext == ".gpkg":
                gdf.to_file(
                    output_path, driver="GPKG", layer=layer or "polygons", index=False
                )
            else:  # .shp
                # Remove existing Shapefile sidecars before overwriting.
                if overwrite:
