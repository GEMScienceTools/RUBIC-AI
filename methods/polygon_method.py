...
class PolygonSetting(QtWidgets.QDialog):
    def __init__(self, parent=None, method=None):
        ...
        self.existing_polygon_button.setObjectName("existing_polygon_button")
        self.existing_polygon_button.setText("Upload existing polygon")
        self.existing_polygon_button.clicked.connect(self.select_polygon)
        
        # Existing Polygon Path Label
        ...
        self.building_value_polygon.setGeometry(QtCore.QRect(int(160 * sf_x), int(340 * sf_y), int(211 * sf_x), int(31 * sf_y)))
        ...
        self.sample_size.setGeometry(QtCore.QRect(int(20 * sf_x), int(380 * sf_y), int(121 * sf_x), int(31 * sf_y)))
        ...
        self.sample_size_polygon.setGeometry(QtCore.QRect(int(160 * sf_x), int(380 * sf_y), int(111 * sf_x), int(31 * sf_y)))
        ...
        self.load_data_button.setGeometry(QtCore.QRect(int(20 * sf_x), int(300 * sf_y), int(271 * sf_x), int(31 * sf_y)))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(int(20 * sf_x), int(460 * sf_y), int(581 * sf_x), int(192 * sf_y)))
