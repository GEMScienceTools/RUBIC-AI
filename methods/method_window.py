...
class InspectionSetting(QDialog):
    def __init__(self, parent=None):
        ...
        self.resize(int(890*sf_x), int(800*sf_y))
        
        # Main widget
        self.method_frame = QtWidgets.QWidget(self)
        # Title
        self.w_tittle = QtWidgets.QLabel(self.method_frame)
        self.w_tittle.setGeometry(QtCore.QRect(int(300 * sf_x), int(0 * sf_y), int(301 * sf_x), int(41 * sf_y)))
        font = QtGui.QFont()
        ...
        self.save_button.setGeometry(QtCore.QRect(int(340 * sf_x), int(760 * sf_y), int(191 * sf_x), int(31 * sf_y)))
        font = QtGui.QFont()
        ...
        self.backg_1.setGeometry(QtCore.QRect(int(10 * sf_x), int(40 * sf_y), int(870 * sf_x), int(171 * sf_y)))
        ...
        self.dafault_img.setGeometry(QtCore.QRect(int(680 * sf_x), int(50 * sf_y), int(181 * sf_x), int(141 * sf_y)))
        ...
        self.backg_2.setGeometry(QtCore.QRect(int(10 * sf_x), int(220 * sf_y), int(870 * sf_x), int(171 * sf_y)))
        ...
        self.specific_img.setGeometry(QtCore.QRect(int(680 * sf_x), int(230 * sf_y), int(181 * sf_x), int(141 * sf_y)))
        ...
        self.local_img.setGeometry(QtCore.QRect(int(680 * sf_x), int(430 * sf_y), int(181 * sf_x), int(141 * sf_y)))
        ...
        self.local_descrip.setGeometry(QtCore.QRect(int(230 * sf_x), int(410 * sf_y), int(430 * sf_x), int(181 * sf_y)))
        ...
        local_html = (
            ...
            "-qt-block-indent:0; text-indent:0px;\">"
            "<span style=\" font-size:inherit;\">"
            "Users should provide a folder containing all the images, as well as a CSV file with the metadata. The CSV file must include columns named 'id', "
            "'latitude', and 'longitude', where 'id' matches the image filename and its extension e.g(*.png, *.jpg)."
        ...
        self.backg_3.setGeometry(QtCore.QRect(int(10 * sf_x), int(400 * sf_y), int(870 * sf_x), int(201 * sf_y)))
        ...
        self.backg_4.setGeometry(QtCore.QRect(int(10 * sf_x), int(610 * sf_y), int(870 * sf_x), int(141 * sf_y)))
        ...
        self.extrapolation_descrip.setGeometry(QtCore.QRect(int(230 * sf_x), int(620 * sf_y), int(430 * sf_x), int(121 * sf_y)))
        ...
        self.extra_img.setGeometry(QtCore.QRect(int(680*sf_x), int(630*sf_y), int(171*sf_x), int(101*sf_y)))
